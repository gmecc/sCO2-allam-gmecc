...
* [Examples](#examples)
  ...
  * [Calculation of cycle parameters](#calculation-of-cycle-parameters)
    ...
    * [Фазовая диаграмма рабочего тела](#фазовая-диаграмма-рабочего-тела)
    * [Изменение плотности в цикле](#изменение-плотности-в-цикле)
    * [TS-диаграмма](#ts-диаграмма)
    * [PH-диаграмма](#ph-диаграмма)
    * [Зависимость КПД от температуры рециркулируемого газа](#зависимость-кпд-от-температуры-рециркулируемого-газа)
    * [Зависимость КПД от температуры нагревателя](#зависимость-кпд-от-температуры-нагревателя)
    * [Зависимость pinch от температуры рециркулируемого газа](#зависимость-pinch-от-температуры-рециркулируемого-газа)
  * [Исследование кризиса недостижимой точки теплообменника](#исследование-кризиса-недостижимой-точки-теплообменника)
    * [Изменение плотности рабочего тела в рекуператоре](#изменение-плотности-рабочего-тела-в-рекуператоре)
    * [Изменение теплоемкости рабочего тела в рекуператоре](#изменение-теплоемкости-рабочего-тела-в-рекуператоре)
    * [Изменение температуры рабочего тела в рекуператоре](#изменение-температуры-рабочего-тела-в-рекуператоре)
    * [Параметры рекуператора](#параметры-рекуператора)
...
## Исследование кризиса недостижимой точки теплообменника

### Изменение плотности рабочего тела в рекуператоре

### Изменение теплоемкости рабочего тела в рекуператоре

### Изменение температуры рабочего тела в рекуператоре
